...
#%%
# code inspired from https://github.com/TannerGilbert/Tutorials/blob/master/Recommendation%20System/Recommendation%20System.ipynb
# code inspired from http://digital-thinking.de/deep-learning-combining-numerical-and-text-features-in-deep-neural-networks/

#%%
def define_model(dict_data_key_clean, model_name, n_layers, full_features, history_name, model_load, gdrive=False):
    '''
    Inputs:     - dict_data_key_clean - 'data_full_clean' (if data_cleaner.py was called on data_full, i.e. 6digit product categories)
    ...
    Outputs:    - None - trains model, evaluates, and saves files to model and history locations specified in call
    ________________________
    '''

    '''
    # STEP 1 - DEFINE THE DATA AND INPUTS
    '''
    ...
    '''
    # STEP 3 - DEFINE THE NN MODEL - INPUTS, LAYERS, AND HYPERPARAMETERS
    '''

    # neural network (NN) model - including multiple layers, embeddings, and engineered features
    # compile NN model
    ...
    # specify model based on number of layers and features
    ...
    '''
    # STEP 3A/B - DEFINING A MODEL FOR TRAINING OR LOADING A PRE-TRAINED MODEL
    '''
    ...
    # set up path for saving model and history
        ...
        # huber loss - good for regression and minimizing effects of extrema
        def Huber(yHat, y, delta=1.):
            return np.where(np.abs(y-yHat) < delta,.5*(y-yHat)**2 , delta*(np.abs(y-yHat)-0.5*delta))

        # define different optimizers to try
    ...
    # setup model to be loaded from disk
    ...
    '''
    # STEP 5 - OUTPUT MODEL HISTORY AND EVALUATION METRICS
    '''
...
def main():
    '''
    Inputs:     Identical to define_model(...) in source code above
    ...
    ________________________
    '''
    # define variables to be called in define_model() function
