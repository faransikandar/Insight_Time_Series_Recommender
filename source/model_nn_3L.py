...
conc_cat = Concatenate(name='Concatenate-Product-Country')([product_vec, country_vec])
dot_cat = Dot(name='Dot-Product-Country', axes=1)([product_vec, country_vec])

# Add fully-connected layers
fc1 = Dense(128, activation='relu', kernel_initializer='glorot_uniform', kernel_constraint=maxnorm(3), name='Dense-1')(conc_cat) #dot_cat
fc2 = Dense(32, activation='relu', kernel_initializer='glorot_uniform', kernel_constraint=maxnorm(3), name='Dense-2')(fc1) #fc4
...
filepath="/content/gdrive/My Drive/Colab Notebooks/Insight_Net_Align/models/model_nn_3L-{epoch:02d}-{loss:.4f}.hdf5"
